...
INSERT INTO child VALUES (101,1008,'Araba','Burak');

--SORU 2: .child tablosuna ted_verginosu 105 olan veri girişi yapınız.
INSERT INTO child VALUES (105,1009,'TV','Ahmet');--->Parent Tabloda 105 olmadığından veri girişi yapılamaz.

--SORU 3: child tablosuna ted_vergino null olan veri girişi yapınız
INSERT INTO child VALUES (NULL,1010,'TV','Ali');

--SORU 4: .parent tablosundaki vergi_no 101 olan veriyi siliniz.
DELETE FROM parent WHERE vergi_no=101;-->Child tablodan silinmeden Parent Tablodan Veri Silinemez
...
DELETE FROM parent WHERE vergi_no=101;-->Child'de silme işlemi gerçekleştiği için, Parent tablodan da silebiliriz.

--SORU 7: .parent tablosunu siliniz
DROP TABLE parent;-->Child tablo silinmeden Parent Tablod Silinemez
...
--SORU 10: parent2 tablosundaki tüm verileri siliniz
DELETE FROM parent2;

--SORU 11: parent2 tablosunu siliniz
DROP TABLE parent2 CASCADE;

--SORU 12: child2 tablosunu siliniz;
DROP TABLE child2;
...
--SORU 13: vergi_no’su 202 olan toptancinin sirket_ismi'ni 'VivoBook' olarak güncelleyeniz.
UPDATE toptancilar SET sirket_ismi='VivoBook' WHERE vergi_no=202;

--SORU 14: toptancilar tablosundaki tüm sirket isimlerini 'NOKIA' olarak güncelleyeniz.
