...
SELECT round(AVG(fiyat)) FROM arac;---->küsüratsız
SELECT round(AVG(fiyat),2) FROM arac;---->ondalıktan 2li
...
--SORU 5: meslekler tablosunu isim'e göre sıralayarak sorgulayınız.
SELECT * FROM meslekler ORDER BY isim;

-- SORU 6: meslekler tablosunda maas'i buyukten kucuge siralayiniz
SELECT * FROM meslekler ORDER BY maas DESC;

-- SORU 7: meslekler tablosunda isim'i 'Ali' olanları,maas'a göre büyükten küçüge sıralayarak sorgulayınız
SELECT * FROM meslekler WHERE isim= 'Ali' ORDER BY maas DESC;

-- SORU 8: meslekler tablosunda soyisim 'i 'Bulut' olanları, maas sıralı olarak sorgulayınız.
SELECT * FROM meslekler WHERE soyisim='Bulut' ORDER BY maas;

-- SORU 9: meslekler tablosunda id degeri 5 den büyük olan, ilk 2 veriyi listeleyiniz
SELECT * FROM meslekler WHERE id>5 LIMIT 2;

-- SORU 10: meslekler tablosunda maası en yüksek 3 kişinin bilgilerini listeleyiniz
SELECT * FROM meslekler ORDER BY maas DESC LIMIT 3;

-- SORU 11: meslekler tablosunda ilk 2 veriden sonra 5 veriyi getirin
SELECT * FROM meslekler OFFSET 2 LIMIT 5;

-- SORU 12: meslekler tablosunda en yüksek maaşı alan 4. 5. 6. kişilerin bilgilerini listele
...
-- SORU 13: Tüm film_name'leri, category'lerini ve filimlerde oynayan actor_name'leri listeleyiniz.
...
-- SORU 14: Tüm actor_name'leri ve film_name'lerini listeleyiniz.
...
--SORU 15: join kullanarak qa_dersleri ve developer_dersleri benzersiz sorgula
